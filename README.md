...
2.	Admin: Đăng nhập vào tài khoản và mật khẩu có ở file Administrator.txt, thực hiện một số chức năng như: Thêm, xoá, tìm, cập nhật hay hiển thị toàn bộ thông tin của nhân viên ứng với số 1,2,3,4,5 hoặc bấm số 6 để thoát.
Sau khi Admin đăng nhập thành công, có thể thực hiện các thao tác qua các phím:
...
*Lưu ý: Nếu đăng nhập sai 3 lần thì thoát
Lần đăng nhập đầu tiên của Nhân viên, đổi mật khẩu sau khi đăng nhập thành công.
